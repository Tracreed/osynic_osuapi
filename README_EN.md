...
<p align="center">
  ...
  <a href="https://docs.rs/osynic_osuapi" target="_blank"><img src="https://img.shields.io/docsrs/osynic_osuapi/0.1.9"/></a>
...
# osynic_osuapi = { version = "0.1.9", default-features = false, features = ["v1", "v2", "wasm"] }
```
