...
<p align="center">
  ...
  <a href="https://docs.rs/osynic_osuapi" target="_blank"><img src="https://img.shields.io/docsrs/osynic_osuapi/0.1.3"/></a>
...
# WASM 环境配置（可选）
# osynic_osuapi = { version = "0.1.3", default-features = false, features = ["v1", "v2", "wasm"] }
```
